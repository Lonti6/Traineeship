...
public class FakeServerRepository implements ServerRepository {
    ...
    public FakeServerRepository() {
        ...
        messages = Arrays.asList("Уснувшая степь слушала его шум. — Не смей отказаться! По гроб жизни обидишь! Не выпьешь —.",
                ...
                "Праздник предполагался в.",
                "— Не смей отказаться! По гроб жизни.",
                "Несмотря на скуку, которая ела меня,.",
                "С правдой умрешь с голоду и.",
                "— Не смей отказаться! По гроб жизни обидишь!.",
                "XII, ст. —Я и сам-то.",
                "— Удивительно, как это он еще на.",
                "Нет, нет, ты решительно глуп! Тебе нужно жену не.",
                "Дело в том, что у нас.",
                "Еще минута, и вы с.",
                "Что и говорить! Мне теперь.",
                "Не понимая ровно ничего, я надел новый.",
                "—Нет, Егор Иваныч,— убеждал.",
                "— Действительно, я… солгал! Я не.",
                "Я сказал несколько старых фраз насчет.",
                "Небось уж и сердце болит у них,.",
                "—А я не знал, что у меня есть.",
                "Он, как и всякий российский.",
                "—Спасибо другу!—.",
                "Дядя Семен Федорыч в самом деле деспот и злой, с.",
                "—Эх!— прошептал голова. Скворцов.",
                "[18 - …студент, которого.",
                "— Удивительно, как это он.",
                "Помнится мне страшный, бешеный вихрь,.",
                "Софусь). — Бог с ним! Я так.",
                "Бывало, мелькнет в окне вагона женская.",
                "— За это самое, что ты.",
                "— И это не страшно. Потом, словно сговорившись,.",
                "] и остроносыми сапогами… Как.",
                "Еще минута, и вы с отчаяния броситесь в.",
                "— После событий 1 марта.",
                "— Не смей отказаться! По гроб.",
                "—Нет, Егор Иваныч,— убеждал его губернатор,—.",
                "— Пей!Жена взяла свой.",
                "Кроме неудач и бед, ничего.",
                "] и проч. —Это подло, милостивый.",
                "—Кто вам поверит?— продолжал.",
                "Праздник предполагался в.",
                "—Нашел, чем.",
                "Вот уж год, как хожу без.",
                "Что же еще недоброе может.",
                "[17 - …не имамы зде пребывающего града, но.",
                "Он, как и всякий российский.",
                "—Ай, батюшки,— изумлялся архиерей,—.",
